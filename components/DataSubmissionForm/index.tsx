...
const DataSubmissionForm = () => {
    ...
    async function getAddress(zipcode: string) {
        ...
        cep(zipcodeFormatted).then((cepResponse) => {
            ...
            cepResponse.neighborhood && setValue('neighborhood', cepResponse.neighborhood, { shouldValidate: true })
            cepResponse.street && setValue('streetAddress', cepResponse.street, { shouldValidate: true })
